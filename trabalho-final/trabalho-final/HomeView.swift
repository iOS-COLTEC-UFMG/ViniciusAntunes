...
extension HomeView {
    ...
    func backgroundColor(for state: SoundLevelState) -> Color {
        switch state {
        case .comfortable:
            return Color(red: 0.173, green: 0.208, blue: 0.255) // Cinza
        case .attention:
            return Color(red: 0.255, green: 0.212, blue: 0.130) // Amarelo
        case .risk:
            return Color(red: 0.230, green: 0.10, blue: 0.2) // Vermelho
        case .disabled:
            return Color.gray
        }
    }
